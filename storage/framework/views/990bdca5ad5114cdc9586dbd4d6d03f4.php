...
unset($__errorArgs, $__bag); ?>" id="identidad" name="identidad" value="<?php echo e(old('identidad')); ?>" maxlength="15" required
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <a href="<?php echo e(route('empleados.index')); ?>" class="btn btn-outline-danger ms-2">Cancelar</a>
                </form>
            </div>
        </div>
    </div>
...
<?php /**PATH C:\Users\manue\PhpstormProjects\RacingParts2.0\resources\views/empleados/create.blade.php ENDPATH**/ ?>