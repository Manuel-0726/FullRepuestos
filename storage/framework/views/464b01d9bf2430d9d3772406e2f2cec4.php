            ...
            <div class="card card-custom h-100 shadow-lg">
                <div class="card-body text-center pb-3 d-flex flex-column">
                    ...
                    <div class="avatar-container mb-4">
                        ...
                        ?>
                        <i class="fas <?php echo e($iconClass); ?> fa-4x <?php echo e($iconColor); ?>"></i>
                    </div>
                    

                    <h4 class="card-title mb-2 text-white"><?php echo e($empleado->nombre); ?> <?php echo e($empleado->apellido); ?></h4>
                    <p class="text-muted-dark mb-3 text-wrap"><?php echo e($empleado->puesto); ?></p>
                    ...
                    <div class="d-flex justify-content-center gap-3 mt-auto pt-2">
                        <a href="<?php echo e(route('empleados.edit', $empleado->id)); ?>" class="btn btn-custom-edit btn-sm rounded-pill shadow-sm px-4">
                            <i class="fas fa-edit me-2"></i> Editar
                        </a>
                        <a href="<?php echo e(route('empleados.index')); ?>" class="btn btn-outline-light btn-sm rounded-pill shadow-sm px-4">
            ...
            <div class="card card-custom h-100 shadow-lg">
                <div class="card-body pb-3">
                    ...
                    <div class="row gx-3 gy-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <p class="mb-2 text-wrap">
                                ...
                                <span class="address-box"><?php echo e($empleado->direccion); ?></span>
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="row gx-3 gy-3">
                        ...
                        <div class="col-md-6">
                            <p class="mb-2 text-wrap"><i class="fas fa-calendar-plus me-2"></i><strong>Registro:</strong> <?php echo e($empleado->created_at ? $empleado->created_at->format('d/m/Y H:i') : 'No disponible'); ?></p>
                            <p class="mb-2 text-wrap"><i class="fas fa-calendar-check me-2"></i><strong>Última actualización:</strong> <?php echo e($empleado->updated_at ? $empleado->updated_at->format('d/m/Y H:i') : 'No disponible'); ?></p>
                        </div>
                    </div>
