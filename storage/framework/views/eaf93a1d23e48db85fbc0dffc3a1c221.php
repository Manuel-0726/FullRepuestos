...
<div class="container py-5">
    <div class="table-container">
        ...
        <a href="<?php echo e(route('empleados.create')); ?>" class="btn btn-primary mb-3">+ Nuevo empleado</a>

        <form action="<?php echo e(route('empleados.index')); ?>" method="GET" class="mb-3" id="searchForm">
            <div class="input-group">
                <input type="text" name="search" id="searchInput" class="form-control" placeholder="Buscar empleado por nombre, apellido o identidad" value="<?php echo e(request('search')); ?>" list="employeeSuggestions">
        ...
        <a href="<?php echo e(route('welcome')); ?>" class="btn btn-outline-light mt-3">Inicio</a>
    </div>
</div>
...
<?php /**PATH C:\Users\manue\PhpstormProjects\RacingParts2.0\resources\views/empleados/index.blade.php ENDPATH**/ ?>