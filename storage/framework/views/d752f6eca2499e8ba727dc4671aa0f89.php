    ...
    <div class="row justify-content-center">
        <div class="col-lg-10">
            <div class="form-container">
                ...
                <?php if($errors->has('duplicado')): ?>
                    <div class="alert alert-primary">
                        <?php echo e($errors->first('duplicado')); ?>

                    </div>
                <?php endif; ?>

                
                <?php if($errors->any() && !$errors->has('duplicado')): ?>
                    <div class="alert alert-danger">
                        <ul class="mb-0">
                ...
                <form id="formProducto" action="<?php echo e(route('productos.store')); ?>" method="POST" novalidate>
                    <?php echo csrf_field(); ?>
                    <div class="row">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <input type="number" name="stock" id="stock" class="form-control" min="0" required value="<?php echo e(old('stock', $producto->stock ?? 0)); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <input type="number" id="precio" name="precio" value="<?php echo e(old('precio')); ?>"
...
unset($__errorArgs, $__bag); ?>" step="0.01" min="0" required>
...
unset($__errorArgs, $__bag); ?>" id="categoria" name="categoria" required>
                                ...
                                <?php $__currentLoopData = $categorias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categoria): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($categoria); ?>" <?php echo e(old('categoria') == $categoria ? 'selected' : ''); ?>>
...
<?php /**PATH C:\Users\manue\PhpstormProjects\RacingParts2.0\resources\views/productos/create.blade.php ENDPATH**/ ?>