<?php $__env->startSection('title', 'Sistema de Productos'); ?>
        ...
        <div class="col-md-5 mb-4">
            <div class="card h-100">
                <div class="card-body text-center">
                    ...
                    <a href="<?php echo e(route('productos.create')); ?>" class="btn btn-success btn-lg w-100">Registrar un nuevo producto</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-5 mb-4">
            <div class="card h-100">
                <div class="card-body text-center">
                    ...
                    <a href="<?php echo e(route('productos.index')); ?>" class="btn btn-success btn-lg w-100">Ver lista de productos</a>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\manue\PhpstormProjects\RacingParts2.0\resources\views/productos/menu.blade.php ENDPATH**/ ?>