            ...
            <form method="POST" action="<?php echo e(route('facturas.update', $factura->id)); ?>" id="formFactura" novalidate>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="cliente" id="cliente"
                           value="<?php echo e(old('cliente', $factura->cliente)); ?>"
...
unset($__errorArgs, $__bag); ?>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const rawJsonString = '<?php echo json_encode($factura->detalles->map(function($detalle) {
                return [
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\manue\PhpstormProjects\RacingParts2.0\resources\views/facturas/edit.blade.php ENDPATH**/ ?>