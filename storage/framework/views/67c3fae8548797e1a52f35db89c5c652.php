...
unset($__errorArgs, $__bag); ?>"
                                ...
                                <option value="Kia" <?php echo e(in_array('Kia', old('Kia', [])) ? 'selected' : ''); ?>>Kia</option>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="d-flex justify-content-start gap-2 mt-4">
                        ...
                        <a href="<?php echo e(route('proveedores.index')); ?>" class="btn btn-outline-danger">Cancelar</a>
                    </div>
                </form>
            </div>
        </div>
...
<?php /**PATH C:\Users\manue\PhpstormProjects\RacingParts2.0\resources\views/proveedores/create.blade.php ENDPATH**/ ?>