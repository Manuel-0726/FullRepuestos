...
unset($__errorArgs, $__bag); ?>" id="telefono" name="telefono" value="<?php echo e(old('telefono', $cliente->telefono)); ?>" maxlength="8" autocomplete="off" />
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.getElementById('limpiarFormulario').addEventListener('click', function() {
                ...
                const originalValues = {
                    nombre: "<?php echo e(old('nombre', $cliente->nombre)); ?>",
                    apellido: "<?php echo e(old('apellido', $cliente->apellido)); ?>",
                    correo: "<?php echo e(old('correo', $cliente->correo)); ?>",
                    telefono: "<?php echo e(old('telefono', $cliente->telefono)); ?>",
                    identidad: "<?php echo e(old('identidad', $cliente->identidad)); ?>",
                    direccion: "<?php echo e(old('direccion', $cliente->direccion)); ?>",
                    sexo: "<?php echo e(old('sexo', $cliente->sexo)); ?>"
                };
