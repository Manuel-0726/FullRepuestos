...
<head>
    ...
    {{-- 🎨 CSS para eliminar el fondo blanco de autocompletado en la identidad 🎨 --}}
    <style>
        /* Regla específica para forzar el fondo transparente en el input de identidad cuando es autocompletado */
                ...
                <form id="empleadoForm" action="{{ route('empleados.update', $empleado->id) }}" method="POST" novalidate>
                    ...
                    <div class="row">
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <input type="text" name="identidad" id="identidad" class="form-control @error('identidad') is-invalid @enderror" value="{{ old('identidad', $empleado->identidad) }}" required maxlength="15" oninput="formatearIdentidad(this)" title="Debe ingresar 13 dígitos numéricos en formato ####-####-#####">
                        ...
                        {{-- 6. Dirección (ocupa el col-md-6 de la fila, pero como textarea) --}}
                        <div class="mb-3 col-md-6">
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            {{-- Se ha eliminado el step="0.01" y se asegura que el valor de la base de datos sea entero para el input --}}
                            <input type="number" name="salario" id="salario" class="form-control @error('salario') is-invalid @enderror" value="{{ old('salario', (int)$empleado->salario) }}" required min="0">
                        ...
                        {{-- 11. Estado (Último campo de la cuadrícula, toma el col-md-6 si hay espacio, sino línea completa) --}}
                        <div class="mb-3 col-md-6">
